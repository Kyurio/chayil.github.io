    ...
    <footer class="py-5">
        <div class="row">
            ...
            <div class="col-6 col-md-2 mb-3">
                <h5>Informacion</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="<?= RUTA_URL ?>documentation"
                            class="nav-link p-0 text-muted">Documentación</a></li>
                    <li class="nav-item mb-2"><a href="<?= RUTA_URL ?>business"
                            class="nav-link p-0 text-muted">Empresas</a></li>
                    <li class="nav-item mb-2"><a href="<?= RUTA_URL ?>faqs" class="nav-link p-0 text-muted">FAQs</a>
                    </li>
                </ul>
            </div>
                ...
                <form>
                    ...
                    <div class="d-flex flex-column flex-sm-row w-100 gap-2">
                        ...
                        <input id="newsletter1" type="text" class="form-control" placeholder="Email"
                            v-model="mail_suscribe">
                        <button class="btn btn-outline-dark" type="button"
                            @click="cheackformSucribe">Subscribete</button>
                    </div>
